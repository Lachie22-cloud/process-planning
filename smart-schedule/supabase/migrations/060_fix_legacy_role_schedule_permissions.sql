-- 060_fix_legacy_role_schedule_permissions.sql
-- Add schedule.view_* permissions to the legacy role fallback map inside
-- get_effective_permissions_for_user. Without this, users whose permissions
-- are resolved via the site_users.role legacy path never receive the new
-- schedule navigation permissions.
