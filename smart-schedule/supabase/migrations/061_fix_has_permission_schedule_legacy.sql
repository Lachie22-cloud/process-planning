-- 061_fix_has_permission_schedule_legacy.sql
-- Add schedule.view_* to the legacy member fallback in auth.has_permission().
-- site_admin already returns TRUE for all permissions so no change needed there.
